...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--source_max_items', type=int, default=-1, help='source max items. use -1 for all dataset')
    ...
    self.parser.add_argument('--img_save_freq', type=int, default=100, help='freq (iteration) of saving images')
